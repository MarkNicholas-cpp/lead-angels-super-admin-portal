export const metadata = {
  title: 'Sign Up - Lead Angels Investment Portal',
                ...
                <div className="flex items-center justify-between mt-6">
                  <div className="mr-1">
                    <label className="flex items-center">
                      ...
                      <span className="text-sm ml-2">I agree to <Link className="text-indigo-500 hover:text-indigo-600 dark:hover:text-indigo-400" href="/">terms &amp; conditions</Link></span>
                    </label>
                  </div>
