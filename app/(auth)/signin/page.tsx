export const metadata = {
  title: 'Sign In - Lead Angels Investment Portal',
            ...
            <div className="max-w-sm mx-auto w-full px-4 py-8">
              ...
              <div className="pt-5 mt-6 border-t border-slate-200 dark:border-slate-700">
                {/* <div className="text-sm">
                  Don't you have an account? <Link className="font-medium text-indigo-500 hover:text-indigo-600 dark:hover:text-indigo-400" href="/notfound">Sign Up</Link>
                </div> <br /> */}
                {/* Warning */}
                {/* <div className="mt-5">
                ...
                <Link className="btn bg-indigo-500 hover:bg-indigo-600 text-white ml-3 left-[500px]" href="/">Sign In With Google</Link>
              </div>
            </div>
